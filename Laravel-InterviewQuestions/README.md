...
<!-- toc -->
- [1. What is _Laravel_ and why is it used?](#1-what-is-_laravel_-and-why-is-it-used)
  * [Key Features](#key-features)
  * [Who Should Use Laravel?](#who-should-use-laravel)
- [2. How does _Laravel_ follow the _MVC_ architecture?](#2-how-does-_laravel_-follow-the-_mvc_-architecture)
  * [MVC Overview](#mvc-overview)
  * [Laravel's Implementation of MVC](#laravels-implementation-of-mvc)
    + [Code Example: MVC in Laravel](#code-example-mvc-in-laravel)
- [3. What server requirements does _Laravel_ have?](#3-what-server-requirements-does-_laravel_-have)
  ...
  * [VHost Configuration](#vhost-configuration)
    + [Additional Apache Directives:](#additional-apache-directives)
    + [Nginx Configuration:](#nginx-configuration)
  * [Version-Specific Adjustments](#version-specific-adjustments)
- [4. How would you install or set up a _Laravel_ project?](#4-how-would-you-install-or-set-up-a-_laravel_-project)
  * [Steps to Set Up a Laravel Project](#steps-to-set-up-a-laravel-project)
  * [Code Example: Laravel's `composer create-project`](#code-example-laravels-composer-create-project)
  * [Code Example: `.env` File](#code-example-env-file)
  * [Code Example: Running Required Commands](#code-example-running-required-commands)
  * [Recommendations](#recommendations)
- [5. Explain _routing_ in _Laravel_.](#5-explain-_routing_-in-_laravel_)
  * [Core Concepts](#core-concepts)
  * [Routing in Laravel](#routing-in-laravel)
  * [Implicit Routing](#implicit-routing)
...
- [6. What are _middleware_ in _Laravel_?](#6-what-are-_middleware_-in-_laravel_)
  * [Middleware in Action](#middleware-in-action)
  * [How Laravel Middleware Works](#how-laravel-middleware-works)
  * [Chain of Responsibility](#chain-of-responsibility)
  * [Creating Custom Middleware](#creating-custom-middleware)
  * [Middleware Groups](#middleware-groups)
  * [Global Middleware](#global-middleware)
- [7. Can you describe the _Laravel_ request lifecycle?](#7-can-you-describe-the-_laravel_-request-lifecycle)
  * [Key Components](#key-components)
  * [Request Lifecycle Steps](#request-lifecycle-steps)
- [8. What are _Service Providers_ in _Laravel_?](#8-what-are-_service-providers_-in-_laravel_)
  * [Key Responsibilities](#key-responsibilities)
  * [Categories of Service Providers](#categories-of-service-providers)
  * [Registration](#registration)
  * [Boot Method](#boot-method)
  * [Relationship with IOC Container](#relationship-with-ioc-container)
- [9. What is _Eloquent ORM_ in _Laravel_?](#9-what-is-_eloquent-orm_-in-_laravel_)
  * [Why Use Eloquent Over Raw SQL?](#why-use-eloquent-over-raw-sql)
  * [Key Eloquent Features](#key-eloquent-features)
    + [1. Eloquent Models](#1-eloquent-models)
    + [2. Eloquent Relationships](#2-eloquent-relationships)
    + [3. Database Querying](#3-database-querying)
  * [Best Practices for Eloquent](#best-practices-for-eloquent)
  * [Code Example: Eloquent Basics](#code-example-eloquent-basics)
  * [Code Example: Defining an Eloquent Relationship](#code-example-defining-an-eloquent-relationship)
  * [Best Practices for Eloquent](#best-practices-for-eloquent-1)
- [10. How does one perform _validations_ in _Laravel_?](#10-how-does-one-perform-_validations_-in-_laravel_)
  * [Basic Data Validation](#basic-data-validation)
  * [Controller Validation](#controller-validation)
  * [Immediate Feedback](#immediate-feedback)
- [11. What are _Laravel Contracts_?](#11-what-are-_laravel-contracts_)
  * [Key Benefits](#key-benefits)
  * [Practical Examples](#practical-examples)
  * [Code Example: Cache Repository Interfaces](#code-example-cache-repository-interfaces)
- [12. Can you describe the directory structure of a _Laravel Framework_?](#12-can-you-describe-the-directory-structure-of-a-_laravel-framework_)
  * [Core Directories](#core-directories)
  * [Extended Directories](#extended-directories)
  * [Housekeeping Directories](#housekeeping-directories)
  * [Auxiliary Directories](#auxiliary-directories)
  * [Often "Unseen" Directories](#often-unseen-directories)
  * [The Why Behind the Structure](#the-why-behind-the-structure)
- [13. How do you configure a _database_ in _Laravel_?](#13-how-do-you-configure-a-_database_-in-_laravel_)
  * [Steps to Configure a Database](#steps-to-configure-a-database)
  * [Code Example: .env Configuration](#code-example-env-configuration)
  * [Code Example: Configuring Databases](#code-example-configuring-databases)
- [14. Explain _migration_ in _Laravel_ and its purpose.](#14-explain-_migration_-in-_laravel_-and-its-purpose)
  * [Core Functionalities](#core-functionalities)
    + [Versioning the Database](#versioning-the-database)
    + [Simplifying Team Collaboration](#simplifying-team-collaboration)
    + [Easy Rollbacks](#easy-rollbacks)
    + [Code Generation for Database Actions](#code-generation-for-database-actions)
  * [Key Features and Benefits](#key-features-and-benefits)
- [15. What is the command to create a _controller_ in _Laravel_?](#15-what-is-the-command-to-create-a-_controller_-in-_laravel_)
  * [Controller Generation Options](#controller-generation-options)
  * [Code Example: Controller with Model](#code-example-controller-with-model)
<!-- tocstop -->
